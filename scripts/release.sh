#!/usr/bin/env bash
#
# release.sh — interactive release driver for eslint-plugin-use-client.
#
...
#   scripts/release.sh prerelease      # cuts a 0.0.2-beta.0 pre-release (CI publishes to the "next" dist-tag)
...
# --- preflight --------------------------------------------------------------
bold "eslint-plugin-use-client release"
echo
